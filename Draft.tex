...
The negative price coefficient of translates to market avergae own price elasticities in the range of -4.1509 to -7.3567 for EVs,
with a standard deviation of 0.7814. A sample of elasticities of Shanghai in 2019 is presented in Table 2 and 3.
...
The own price elasticities are generally greater than 1 in absolute value, 
which are inline with the literature on vehicle demand taking price units into account (Li et al., 2017), (Springel, 2021), (Remmy, 2024), (Barwick et al., 2024).
The 
...
As for the supply estimates, 

\begin{table}[!htbp] \centering
\begin{tabular}{@{\extracolsep{5pt}}lc}
\\[-1.8ex]\hline
\hline \\[-1.8ex]
& \multicolumn{1}{c}{\textit{Dependent variable: log(charging\_stations\_stock)}} \\
\cline{2-2}
\\[-1.8ex] & (1) \\
\hline \\[-1.8ex]
 fixed subsidy & 0.00001$^{}$ \\
& (0.00034) \\
 operating subsidy & 0.27069$^{}$ \\
& (0.46970) \\
 EV base & 2.04827$^{**}$ \\
& (0.97011) \\
\hline \\[-1.8ex]
 ...
 Observations & 155 \\
 $R^2$ & 0.95920 \\
 Residual Std. Error & 1.77141 (df=117) \\
 F Statistic & 703901.59878$^{***}$ (df=38; 117) \\
\hline
\hline \\[-1.8ex]
\textit{Note:} & \multicolumn{1}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\
\end{tabular}
