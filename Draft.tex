...
For the past two decades, China has been at the forefront of EV adoption, with a significant share of the global new EV sales of 60\% in 2023. 
To achieve the annoued policy objective of hitting 60\% EV market share by 2030, Chinese government has implemented a range of policies to promote EV adoption, 
...
EV policies have been pivotal to the net-zero target of China, where a wide-range of policies have been entering, substituting and existing in a frequent basis, 
allowing for many additional policy questions to be answered by evaluating the rich set of policy mix.
In particular, the question on the effect of policy phase-out is rarely asked for this relatively young industry, 
and this paper adds to that direction, by extending the question of optimal policy mix in Springel (2021) to exploring the compensatory effects of policy substitutions.
Therefore, this paper aims to structurally modelling decisions on vehicle purchase and charging infrastructure provision, exploring the indirect network effects between EVs demand and charging network,
in order to answer policy questions and identify efficient policy mix in incentivizing EV adoption.
...
In the period of 2019-2023, with the full ramp-down of uniform purchase subsidies, attribute-based subsidies and tax exemptions were the only major central incentives remaining. 
...
In comparison to the EV market, the charging market is much more concentrated with top players dominating market shares.
In 2023, out of the total 2.7 million public charging piles, the top 5 charging station providers occupied over 62\% of the market share and 81\% of total charging power output.
Following the phasing-out in EV purchase subsidies, the focus of incentives has shifted towards charging infrastructure, targeting EV-pile ratio.
...
but introduced incompatible charging standards to the supply side and focused primarily on the impact of a uniform-standard policy for EV penetration. 
...
where a larger stock of EVs would increase the profitability for charging providers and give rise to expanding charging network, which in turn increases the convenience of owning an EV.
...
and attribute-based subsidies (Jia et al., 2023; Barwick et al., 2024), also in supply-side targets like charging infrastructure subsidies (Li et al., 2017; Springel, 2021; Zhu et al., 2024) and charging standards (Li, 2023).
...
\hline
 ...
 \ $\Delta$ Piles        & 0 (0\%) & 36566 (1.5\%)  & 264275 (10.9\%) & 43692 (1.8\%)   & 44663 (1.8\%)   & 114279 (4.7\%)  \\
 Gov Spending (¥)      & 0      & 90642080276   & 258733108812   & 110150772525   & 111527210925   & 284255263283   \\
 \ $\Delta$ EV per M¥    & -      & 10.31         & 1.20           & 10.68          & 9.55           & 8.29           \\
 \ $\Delta$ Piles per M¥ & -      & 0.40          & 1.02           & 0.40           & 0.40           & 0.40           \\
\hline
\end{tabular}
\end{center}
