...
\section{Abstract}
This study structurally models a two-sided market formed by EVs and charging providers,
using province-level annual vehicle sales data in China from 2019 to 2023. 
EV demands under indirect network effects are examined for evaluation of policy impacts on EV adoptions.
Part of calculated price elasticities exhibits increased complementarity across models, confirming the presence of significant indirect network effects, 
while this result exhibits some heterogeneities that are context-dependent across markets.
Counterfactual results suggest that the implemented policy mix incentivized 4.7\% increase in EV adoption and 3.3\% increase in charging piles deployment,
and comparative analysis of different subsidies indicates that a uniform purchase subsidy is the most efficient overall.
Targeted policies on purchase price of EVs exhibit the most significant impact when considering only EV adoption.
In particular, uniform purchase subsidy is more cost-effective than non-uniform subsidies such as tax exemptions and range-based incentives,
while externalities from feedback effects are present but not to the same extent as direct effects.
